...
package start.application.commons.zip;

import static start.application.commons.zip.ZipConstants.DATA_DESCRIPTOR_MIN_VERSION;
import static start.application.commons.zip.ZipConstants.DWORD;
import static start.application.commons.zip.ZipConstants.INITIAL_VERSION;
import static start.application.commons.zip.ZipConstants.SHORT;
import static start.application.commons.zip.ZipConstants.WORD;
import static start.application.commons.zip.ZipConstants.ZIP64_MAGIC;
import static start.application.commons.zip.ZipConstants.ZIP64_MAGIC_SHORT;
import static start.application.commons.zip.ZipConstants.ZIP64_MIN_VERSION;
import static start.application.commons.zip.ZipLong.putLong;
import static start.application.commons.zip.ZipShort.putShort;
